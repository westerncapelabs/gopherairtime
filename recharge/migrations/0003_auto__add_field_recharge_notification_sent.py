...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recharge.notification_sent'
        db.add_column(u'recharge_recharge', 'notification_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recharge.notification_sent'
        db.delete_column(u'recharge_recharge', 'notification_sent')
    ...
    models = {
        ...
        u'recharge.recharge': {
            ...
            'reference': ('django.db.models.fields.BigIntegerField', [], {'default': '138315178760700L', 'unique': 'True'}),
