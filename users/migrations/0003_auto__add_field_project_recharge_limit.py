...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.recharge_limit'
        db.add_column(u'users_project', 'recharge_limit',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.recharge_limit'
        db.delete_column(u'users_project', 'recharge_limit')
